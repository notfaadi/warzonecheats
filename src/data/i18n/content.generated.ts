		...
		en: {
			...
			pages: {
				...
				"warzone-esp": {
					...
					intro: "Warzone esp visibility tools for BR and Resurgence. Read enemy squads, squads, bots, loot, and distance before you commit — toggleable warzone esp wallhack overlays bundled in our warzone cheats package.",
				...
				hacks: {
					...
					intro: "Warzone cheats for BR and Resurgence combine ESP wallhack visibility, 2D radar-style threat cues, and Aimbot controls in one undetected Windows PC license — maintained after Ricochet patches. This is the pillar guide for warzone cheats in 2026.",
				...
				"esp-hack": {
					...
					intro: "Warzone ESP hack overlays for Warzone — player outlines, boss threat cues, loot and container markers with distance readouts across BR and Resurgence.",
